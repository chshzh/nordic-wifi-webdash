...
| P2P pairing method | `pbc -g 0` (push-button connect, device is GI) | PBC is simpler than PIN for demo use; `-g 0` forces GI role so phone is GO and assigns IPs |
